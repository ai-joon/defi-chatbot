...
tools = load_tools(
    "ta_config/indicators", "ta_config/forex_config.yaml", "FOREX", "DEFAULT"
)
...
class SearchSchema(BaseModel):
    question: str = Field(description="Forward the user's question to the forex expert")


class ForexTool(BaseTool):
    name = "forex_expert"
    description = """Useful for when you need to answer questions related to financial indicators for the foreign exchange market (forex)"""
