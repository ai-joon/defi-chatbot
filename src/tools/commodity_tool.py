...
tools = load_tools(
    "ta_config/indicators", "ta_config/commodity_config.yaml", "COMMODITY", "DEFAULT"
)
...
class SearchSchema(BaseModel):
    question: str = Field(
        description="Forward the user's question to the commodity expert"
    )


class CommodityTool(BaseTool):
    name = "commodity_expert"
    description = """Useful for when you need to answer questions related to financial indicators for commodities"""
                ...
                json.dumps(
                    {
                        ...
                        "message": f"Using commodity tool...",
                    }
                ),
